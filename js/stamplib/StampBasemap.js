...
// 	gMap = $("#map2dv")[0].contentWindow.gMap;
// 	ol = $("#map2dv")[0].contentWindow.ol;
// 	mapDoc = $("#map2dv")[0].contentDocument;
// 	loadEarthData(params.screen);
// });

window.onload = function () {
    $("#map2dv")[0].contentWindow.initialize();
    gMap = $("#map2dv")[0].contentWindow.gMap;
    ol = $("#map2dv")[0].contentWindow.ol;
    mapDoc = $("#map2dv")[0].contentDocument;
    $("#map2dv")[0].contentWindow.initPosData();
    loadEarthData(params.screen);
}
...
function loadEarth(earthObj, screen) {
    ...
    stampConfig += '</xml>';
    var resload = earthObj.Load_s(params.ip, stampConfig);
    console.log(resload);
}
