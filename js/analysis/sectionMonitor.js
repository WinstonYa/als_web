...
$(function(){
    ...
    $("#btnStart").click(function(){
        ...
        earth.Event.OnCreateGeometry = function(p,cType){
            ...
            dmLine = earth.Factory.CreateElementLine(earth.Factory.CreateGUID(), "断面线");
            dmLine.BeginUpdate();
            dmLine.SetPointArray(p);
            dmLine.LineStyle.LineWidth = 1;
            dmLine.LineStyle.LineColor = 0xffFFFF00;
            dmLine.AltitudeType = 1;
            dmLine.Selectable = false;
            dmLine.Editable = false;
            dmLine.EndUpdate();
            earth.AttachObject(dmLine);
            var guidStr = "";
