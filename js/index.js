...
var ol = null;
var mapDoc = null;
var skipDoSomething = null;
var backDoSomething = null;
...
var headerHeight = 121; //标题栏高度
var dialogLeft = Math.ceil(86 * zoomInit); //弹出框靠左距离
// var dialogLeft = Math.ceil(86 * 1); //弹出框靠左距离
...
//     dataType: 'text',
//     type: 'POST',
//     url: 'http://www.hclbs.com:9006/admin/login.aspx',
//     data: {
//         __VIEWSTATE: '/wEPDwUJNjU1NTk3OTE2ZGQP8ekNtu75q1XNIaYRVxuR2+bba559RwOOkGCQR6T4mA==',
//         __VIEWSTATEGENERATOR: '82312306',
//         __EVENTVALIDATION: '/wEdAATpR5EG8K5uZFnFmAOW8VT5Y3plgk0YBAefRz3MyBlTcHY2+Mc6SrnAqio3oCKbxYY85pbWlDO2hADfoPXD/5tdRdnnF2PWGnPyDhc8GVB4Qlww7DvBcQo0v9RJyg9JN8A=',
//         txtUserName: 'alstlbf',
//         txtPassword: '123456',
//         btnSubmit: '登陆'
//     },
...
//         }
//     }, function (err) {
//     }, null, params.serviceIp + '/login/user', 'post',
//     {username: "ssy", password: "123"}
// );
var CN = /[^u4e00-u9fa5]/
 ...
 * @return {[type]} [description]
 */
function getLeftPanelObject() {
    // var map3 = document.getElementById("map3dv");
    var left = $("#leftPanel");
    return left;
}
 ...
 */
function showTable() {
    getLeftPanelObject().hide();
    // getMainEarthObject().hide();
    resizeEarthToolWindow();
    getTableObject().show();
    $("#mainEarth").css("margin-left", "1px");
}
 ...
 */
function showMain() {
    getLeftPanelObject().show();
    getMainEarthObject().show();
    // resizeEarthToolWindow();
    getTableObject().hide();
...
function skip2DMap() {
    ...
    getMainEarthObject().show();
    get2DMapObject().show();
    $("#map2dv")[0].contentWindow.showBackButton();
    $("#mainEarth").css("margin-left", "0px");

    if (typeof skipDoSomething === 'function') {
        skipDoSomething()
    }
    skipDoSomething = null;
}
...
function back2Table() {
    ...
    // get2DMapObject().hide();
    getTableObject().show();
    $("#map2dv")[0].contentWindow.hideBackButton();
    $("#mainEarth").css("margin-left", "1px");

    if (typeof backDoSomething === 'function') {
        backDoSomething()
    }
    backDoSomething = null;
}

function clear2DBack() {
    $("#map2dv")[0].contentWindow.hideBackButton();
    if (typeof backDoSomething === 'function') {
        backDoSomething()
    }
...
function resizeEarthToolWindow() { //工具栏重新调整窗口
    if (earthToolsBalloon) {
        earthToolsBalloon.SetIsVisible(get3DMapObject().is(":visible"));
    }
