...
//巡逻监控
// function topClicked(id) {
function PatrolMonitorClicked(id) {
    top.show2DMap();
    showDialog('html/alsm/patrolManage/realtime.html', id, function () {
        cancelPatrol();
    });
}

//走访监控
function VisitMonitorClicked(id) {
    top.show2DMap();
    showDialog('html/alsm/visitManage/VisitMonitor.html', id, function () {
        cancelPolice();
    });
}

//巡逻轨迹
function PatrolTrackClicked(id) {
    top.show2DMap();
    showDialog('html/alsm/patrolManage/PatrolTrack.html', id, function () {
        cancelPatrol();
    });
}

//轨迹管理
function PatrolTraceManageClicked(id) {
    top.show2DMap();
    showDialog('html/alsm/patrolManage/TraceManage.html', id, function () {
        cancelPatrol();
    });
}

//轨迹管理
function VisitTraceManageClicked(id) {
    top.show2DMap();
    showDialog('html/alsm/visitManage/TraceManage.html', id, function () {
        cancelPatrol();
    });
}

//巡逻路线
function PatrolRouteClicked(id) {
    top.show2DMap();
    showDialog('html/alsm/patrolManage/PatrolRoute.html', id, function () {
        cancelPatrol();
    });
}
//走访路线
function VisitRouteClicked(id) {
    top.show2DMap();
    showDialog('html/alsm/visitManage/VisitRoute.html', id, function () {
        cancelPatrol();
    });
}

//走访轨迹
function VisitTrackClicked(id) {
    top.show2DMap();
    showDialog('html/alsm/visitManage/VisitTrack.html', id, function () {
        cancelPolice();
    });
}

//事件管理
function EventManagementClicked(id) {
    showTableDialog('html/alsm/patrolManage/EventManagement.html', id);

}

//巡逻任务
function PatrolTaskClicked(id) {
    // window.open('http://ttyu.net:8080/patrol/patrolManage/task.html', '_blank');
    // window.open('http://www.hclbs.com:9006/admin/xhdd/xhrw_list.aspx', '_blank');
    // showModalDialog('http://www.hclbs.com:9006/admin/xhdd/xhrw_list.aspx');
    showTableDialog('html/alsm/patrolManage/task.html', id);
}
//周期评定
function CycleEvaluateClicked(id) {

    showTableDialog('html/alsm/patrolManage/CycleEvaluate.html', id);
}



//走访任务
function VisitTaskClicked(id) {
    showTableDialog('html/alsm/visitManage/VisitTask.html', id);
}

//走访记录
function VisitRecordingClicked(id) {
    showTableDialog('html/alsm/visitManage/VisitRecording.html', id);
}
//巡逻路线
function PatrolPathClicked() {

}

//巡逻统计分析
function PatrolAnalysisClicked(id) {
    showTableDialog('html/alsm/patrolManage/analysis.html', id);
}

//走访统计分析
function VisitAnalysisClicked(id) {
    showTableDialog('html/alsm/visitManage/analysis.html', id);
}

//视频监控
function VideoMonitorClicked(id) {
    top.show2DMap();
    showDialog('html/alsm/monitorManage/hlsmonitor.html', id, function () {
        top.showMonitorPoints([]);
        top.showMonitorOverlay(undefined, '');
    });
}

//远程调解
function VideoMeetingClicked(id) {
    showTableDialog('https://ws.hst.com/userCenter.html', id);
}

//大漠110
function Desert110Clicked(id) {
    showTableDialog('http://39.104.107.139:8001/admin/index/index', id);
}

//钉钉办公
function DingDingClicked(id) {
    showTableDialog('https://attend.dingtalk.com/portal/index.html#/attendance/statisticsTotal', id);
}

//闭环管理
// 外来人员信息
function ForeperClicked(id) {
    showTableDialog('html/PdcaCycle/Foreignpersonnel.html', id);
}

//外来车辆信息
function vehicleClicked(id) {
    showTableDialog('html/PdcaCycle/vehiclemanagement.html', id);
}

//边检站
function securityClicked(id) {
    top.show2DMap();
    showDialog('html/PdcaCycle/securityManagement.html', id, function () {
        gMap.getsmtlayer('bjkk').setVisible(false);
    });
}

//数据管理
//测试  -> 集合所有表
function MusterClicked(id) {
    // window.open('http://ttyu.net:8080/patrol/patrolManage/task.html', '_blank');
    // window.open('http://www.hclbs.com:9006/admin/xhdd/xhrw_list.aspx', '_blank');
    // showModalDialog('http://www.hclbs.com:9006/admin/xhdd/xhrw_list.aspx');
    showTableDialog('html/wordManager/WordManger.html', id);
}
//人口管理
//人口统计
function rktjClicked(id) {
    // window.open('http://ttyu.net:8080/patrol/patrolManage/task.html', '_blank');
    // window.open('http://www.hclbs.com:9006/admin/xhdd/xhrw_list.aspx', '_blank');
    // showModalDialog('http://www.hclbs.com:9006/admin/xhdd/xhrw_list.aspx');
    showTableDialog('html/alsm/summaryGraph/people.html', id);
}
function mhzxClicked(id) {
    // window.open('http://ttyu.net:8080/patrol/patrolManage/task.html', '_blank');
    // window.open('http://www.hclbs.com:9006/admin/xhdd/xhrw_list.aspx', '_blank');
    // showModalDialog('http://www.hclbs.com:9006/admin/xhdd/xhrw_list.aspx');
    showTableDialog('html/view/populationManager.html', id);
}

//暂住人口
function zzrkClicked(id) {
    showTableDialog('html/view/TempPopulation.html', id);
    // window.open('http://www.hclbs.com:9006/admin/xhdd/xhry_list.aspx', '_blank');
}

//实有单位

//场所统计
function CSTJClicked(id) {
    showTableDialog('html/alsm/summaryGraph/place.html', id);
}

function SBDWClicked(id) {
    showTableDialog('html/view/BoomCompanyManager.html', id);
}

//实有单位  ->  企事业单位
function QSWDWClicked(id) {
    showTableDialog('html/view/companyManager.html', id);
}

//实有单位  ->  特种行业
function TZHYClicked(id) {
    showTableDialog('html/view/SpecialIndustry.html', id);
}

//实有单位  ->  商业网点
function SYWDClicked(id) {
    showTableDialog('html/view/CommercialPoint.html', id);
}

//实有单位  ->  出租房屋
function CZFWClicked(id) {
    showTableDialog('html/view/RentalHousing.html', id);
}

function YQYFClicked(id) {

}
//其它场所
function TYSJClicked(id) {
    showTableDialog('html/view/generalData.html', id);
}

//系统设置部门管理
function bmglClicked(id) {
    showTableDialog('html/divisionmanagement/divisionmanagement.html', id);
    // window.open('http://www.hclbs.com:9006/admin/xhdd/xhry_list.aspx', '_blank');
}

//系统设置民警管理
function policlClicked(id) {
    showTableDialog('html/divisionmanagement/policeman.html', id);
    // window.open('http://www.hclbs.com:9006/admin/xhdd/xhry_list.aspx', '_blank');
}

//系统设置堡垒户管理
function yhglClicked(id) {
    showTableDialog('html/divisionmanagement/personnelmanagement.html', id);
    // window.open('http://www.hclbs.com:9006/admin/xhdd/xhry_list.aspx', '_blank');
}

//退出登录
function UsercontolClicked(id) {
//  window.opene('html/Logout/logout.html', id);
    showTableDialog('html/Logout/logout.html', id);
    // window.open('http://www.hclbs.com:9006/admin/xhdd/xhry_list.aspx', '_blank');
}
