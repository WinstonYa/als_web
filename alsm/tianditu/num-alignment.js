var alignmentFns = {
    ...
    init: function (input, step, max, min, digit) {
        ...
        //添加左右加减号
        input.wrap("<div id = '" + input.attr('id') + "div' class='el-button' style = 'padding:0;width:" + width + "px;height:" + (height + 2) + "px;border: 1px solid #CCC;'></div>");
    ...
    initialize: function () {
        ...
        inputs.each(function () {
            ...
            var data_edit = this.dataset["edit"];
            if (data_edit) {
